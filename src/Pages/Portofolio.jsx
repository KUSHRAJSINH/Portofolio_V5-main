...
const techStacks = [
  ...
  { icon: "Git.jpeg", language: "Git" },
  { icon: "python2.jpg", language: "Python" },
  { icon: "firebase.svg", language: "Firebase" },
  { icon: "ML.png", language: "ML" },
  { icon: "AI.webp", language: "AI" },
  { icon: "django.jpeg", language: "Django" },
];
...
const projectsData = [
  ...
  {
    id: 3,
    Img: "path/to/leave_management_image.jpg",
    Title: "Leave Management System",
    Description: "A leave management system built using OOP concepts in Python.",
    Link: "https://github.com/yourusername/leave_management",
    TechStack: ["Python", "OOP"],
  },
  {
    id: 4,
    Img: "path/to/face_recognition_image.jpg",
    Title: "Face Recognition System",
    Description: "A face recognition system built with Python.",
    Link: "https://github.com/yourusername/face_recognition",
