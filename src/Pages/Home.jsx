...
const WORDS = ["Artificial Intelligence & Machine Learning Student", "Innovating with AI & Web Development"];
const TECH_STACK = ["Python", "React.js", "Django", "Machine Learning"];
const SOCIAL_LINKS = [
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Creating intelligent, innovative, and user-friendly AI & ML solutions.
                </p>
